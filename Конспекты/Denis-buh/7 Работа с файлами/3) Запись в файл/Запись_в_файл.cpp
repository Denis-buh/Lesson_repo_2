...
int main(int argc, char* argv[])
{
    ...
    string path_new = "D:\\Разработки разработчика\\Проекты\\My Soft\\My_Textbook_cpp\\7 Работа с файлами\\3) Запись в файл";
    ...
    file.open(name_file, ofstream::app); // Открытие файла в режиме перезаписи (если файла нет, то он его создаст)
