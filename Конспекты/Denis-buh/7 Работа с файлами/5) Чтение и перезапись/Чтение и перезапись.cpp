...
int main(int argc, char* argv[])
{
    ...
    string path_new = "D:\\Разработки разработчика\\Проекты\\My Soft\\My_Textbook_cpp\\7 Работа с файлами\\5) Чтение и перезапись";
    ...
    file.open(name_file, fstream::in | fstream::out); // Открытие файла в режиме чтения перезаписи (если файла нет, то он его не создаст)
