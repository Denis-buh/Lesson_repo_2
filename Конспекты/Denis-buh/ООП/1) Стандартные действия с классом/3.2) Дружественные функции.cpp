...
using namespace std;
/*
Дружественные функции - функции которые не являются атрибутами класса, но имеют достут к закрытым атрибутам.
Обычно дружественная функция получает в качестве аргумента тот обьект класса к которому пренадлежит.
...
public:
    ...
    // Обьявление дружественной функции
