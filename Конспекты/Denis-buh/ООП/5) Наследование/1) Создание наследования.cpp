...
class "Имя класса наследника": "ключь доступа" "Имя класса родителя"{
...
Ключь доступа можно и не указывать (тогда по умолчанию будет prived (для классов) public (для стуктур))
}
*/
