...
private:
    Football_comand* arr_command; // Массив футбольных команд
    ...
    Football_comand made_command(int nimber){
        while (true){
            ...
            if (flag == 2){
                return Football_comand(name_command, city, points); 
            }
        }
    }
...
public:
    ...
    void append_command(){
        ...
        this->print();
        cout << "Позиция новой команды в общем списке = " << position << "\n";
        system("pause");
