...
int main()
{
	...
	for (int arr_index = 0; arr_index < 15; arr_index++)//цикл, что вносит в массив случ. числа
	{
		for (int el_index_aux = 0; el_index_aux < 15; el_index_aux++)
		{
			main_array[arr_index][el_index_aux] = (rand() % 11) - 5;//непосредственно внос рандомных чисел
		}
	}
